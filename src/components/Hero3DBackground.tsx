...
export const Hero3DBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      // Map mouse to 3D space for gravity (approximate)
      targetMouse.x = (e.clientX / window.innerWidth - 0.5) * 120;
      targetMouse.y = -(e.clientY / window.innerHeight - 0.5) * 80;
      targetMouse.z = 0;
    };
    ...
    const animate = () => {
      ...
      // Update particle positions with gravity interaction
      let lineIndex = 0;
      ...
      for (let i = 0; i < particleCount; i++) {
        ...
        // Gravity attraction towards mouse
