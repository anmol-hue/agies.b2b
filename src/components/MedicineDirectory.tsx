  ...
  return (
    <div className="w-full space-y-8 pb-16">
      ...
      <div className="space-y-3">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-blue-50/80 border border-blue-200 text-blue-700 text-[10px] font-bold tracking-wider uppercase">
      ...
      {subTab === 'directory' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {filteredMedicines.map((med, idx) => (
              <motion.div
                ...
                className="glass-panel rounded-2xl p-6 flex flex-col justify-between hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/10 transition-all group"
              >
                <div className="space-y-3">
          ...
          <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-blue-950 to-slate-900 p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg border border-slate-800 glass-panel">
            <div className="space-y-1 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2 text-blue-400 text-[10px] font-bold tracking-wider uppercase font-mono">
            ...
            >
              <span className="uppercase">LAUNCH 3D IDENTIFIER</span>
