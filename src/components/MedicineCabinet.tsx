    ...
    <div className="w-full space-y-10 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="clinical-panel rounded-3xl p-6 sm:p-8 space-y-6 shadow-none">
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs tracking-wider transition-all flex items-center gap-1.5 border border-blue-400/50 cursor-pointer shadow-sm"
              >
            ...
            <div className="space-y-4">
                      ...
                      <div className="space-y-1.5 flex-1">
                        <div className="flex items-center gap-2">
                          <h3 className="font-extrabold text-lg text-slate-100 tracking-tight flex items-center gap-2">
                            <span>{item.name}</span>
                            {item.takenToday && (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-950 text-emerald-400 text-[10px] font-extrabold border border-emerald-500/30">
                                <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                                <span>Logged</span>
                              </span>
                            )}
                          </h3>
                          <span className="text-[11px] font-extrabold text-slate-400 bg-slate-800 px-2 py-0.5 rounded">
                            {item.frequency}
                          </span>
                        </div>
                        ...
                        <div className="flex items-center gap-4 text-[11px] font-mono font-semibold text-slate-500 pt-1">
                          ...
                          {matchingMed && (
                            <button
                              ...
                              className="text-blue-400 hover:text-blue-400 font-sans text-[11px] font-bold underline flex items-center gap-1 cursor-pointer"
                            >
              ...
              {cabinet.length === 0 && (
                <div className="text-center py-12 bg-slate-950 rounded-2xl space-y-3">
                  <Briefcase className="w-8 h-8 text-slate-300 mx-auto" />
                  <div className="font-bold text-sm text-slate-300">Your Medicine Cabinet is Empty</div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="clinical-panel rounded-3xl p-6 sm:p-8 space-y-4 shadow-none text-center relative overflow-hidden">
            ...
            <div className="text-5xl font-extrabold text-blue-400 tracking-tight font-['JetBrains_Mono',monospace]">
              {adherencePercentage}%
            </div>
            
            <div className="text-xs font-extrabold tracking-widest text-slate-300 uppercase">
          ...
          <div className="clinical-panel rounded-3xl p-6 space-y-4 shadow-none">
            ...
            <div className="space-y-3">
              {history.map((h) => (
                <div 
                  ...
                  className="p-3 rounded-xl bg-slate-950 hover:bg-blue-900/20 border border-slate-800 transition-colors cursor-pointer space-y-1"
                >
      ...
      <div className="space-y-4 pt-4 border-t border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="clinical-panel rounded-2xl p-6 space-y-4 flex flex-col justify-between shadow-none hover:border-blue-500/50 transition-all">
            <div className="space-y-2">
              <h3 className="font-bold text-lg text-slate-100">AI Clinical Scans</h3>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl border border-slate-800 hover:bg-slate-800 text-slate-300 text-xs font-bold tracking-wider uppercase transition-colors cursor-pointer"
            >
              VIEW LOG
            </button>
          </div>
          ...
          <div className="clinical-panel rounded-2xl p-6 space-y-4 flex flex-col justify-between shadow-none hover:border-blue-500/50 transition-all">
            <div className="space-y-2">
              <h3 className="font-bold text-lg text-slate-100">Interaction Reports</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="clinical-panel rounded-2xl p-6 space-y-4 flex flex-col justify-between shadow-none hover:border-blue-500/50 transition-all">
            <div className="space-y-2">
              <h3 className="font-bold text-lg text-slate-100">Symptom Logs</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        {inspectItem3D && (
          <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
            <motion.div
              ...
              className="relative w-full max-w-md clinical-panel rounded-3xl shadow-2xl p-6 space-y-4"
            >
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div>
                  <span className="text-[10px] font-bold text-blue-400 font-mono">3D PATIENT MEDICATION</span>
                  <h3 className="text-lg font-extrabold text-slate-100">{inspectItem3D.name}</h3>
                </div>
                <button
                  onClick={() => setInspectItem3D(null)}
                  className="text-slate-400 hover:text-slate-400 cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-3 bg-slate-950 rounded-xl text-xs text-slate-400 space-y-1">
                <div><span className="font-bold text-slate-300">Prescription:</span> {inspectItem3D.instructions}</div>
                <div><span className="font-bold text-slate-300">Next Scheduled Dose:</span> {inspectItem3D.nextDose}</div>
              </div>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in">
          <div className="relative w-full max-w-md clinical-panel rounded-3xl shadow-2xl p-8 space-y-6 my-8">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <h3 className="text-lg font-extrabold text-slate-100">Add New Medication</h3>
              <button
            ...
            <div className="space-y-4 text-xs">
              <div className="space-y-1.5">
                <label className="font-bold text-slate-400">Select Pharmaceutical Molecule</label>
                <select
                  value={selectedMedToAdd}
                  onChange={(e) => setSelectedMedToAdd(e.target.value)}
                  className="w-full p-3 rounded-xl border border-slate-800 bg-slate-950 font-semibold text-slate-100 text-xs"
                >
                  {MEDICINES.map((m) => (
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-slate-400">Dosage & Frequency</label>
                <input
                  type="text"
                  value={customDosage}
                  onChange={(e) => setCustomDosage(e.target.value)}
                  placeholder="e.g. 500mg (3x Daily)"
                  className="w-full p-3 rounded-xl border border-slate-800 bg-slate-950 text-slate-100 text-xs font-medium"
                />
              </div>

              <div className="space-y-1.5">
                <label className="font-bold text-slate-400">Physician Notes / Instructions</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-slate-400">Next Scheduled Dose Time</label>
                <input
                  type="text"
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
              <button
                onClick={() => setShowAddModal(false)}
                className="px-4 py-2.5 rounded-xl border border-slate-800 text-slate-400 hover:text-slate-100 font-bold text-xs cursor-pointer"
              >
                Cancel
              </button>
              <button
                onClick={handleAddNewMolecule}
                className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs tracking-wider shadow-md cursor-pointer"
              >
                Save Molecule
              </button>
            </div>
      ...
      {viewHistoryModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in">
          <div className="relative w-full max-w-lg clinical-panel rounded-3xl shadow-2xl p-8 space-y-4 my-8">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="space-y-0.5">
                <span className="text-[10px] font-bold text-blue-400 font-mono uppercase">{viewHistoryModal.type}</span>
                <h3 className="text-lg font-extrabold text-slate-100">{viewHistoryModal.title}</h3>
              </div>
              <button
            ...
            <div className="space-y-3 text-xs text-slate-400">
              ...
              <div className="p-4 bg-blue-900/20 border border-blue-500/30 rounded-xl space-y-1">
                <div className="font-extrabold text-blue-400 text-sm">Result: {viewHistoryModal.resultSummary}</div>
                <p className="text-slate-400">{viewHistoryModal.details || 'Standard diagnostic profile verification recorded.'}</p>
              </div>
            </div>
